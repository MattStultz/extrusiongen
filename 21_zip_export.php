...
<tr>
  ...
  <td valign="top">
        <input type="number" id="mesh_hull_strength" name="mesh_hull_strength" value="0" class="tooltip" title="..." onchange="javascript:bezierCanvasHandler.redraw();" onkeyup="javascript:bezierCanvasHandler.redraw();" />px
...
<form name="stl_form">
  ...
  <input type="button" value="Save STL ..." onclick="STLBuilder.saveSTL( preview_mesh.geometry, document.forms['stl_form'].elements['stl_filename'].value );" /> 
</form>
</div>
...
<form name="zip_import_form">
  ...
  <input type="button" value="Upload ZIP file" onclick="window.alert('Sorry. This is not yet implemented.');">							     
 (NOT YET IMPLEMENTED)
</form>
